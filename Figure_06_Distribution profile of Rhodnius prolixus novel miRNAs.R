...
Known_miRNA <- read_excel(file.path(basepath, "csv_files", "mirnas_venn.xlsx"), sheet = "novel_venn")
...
pdf(file = file.path(basepath, "Plots", "Figure_06_Distribution profile of Rhodnius prolixus novel miRNAs.pdf"))
grid.draw(venn)
dev.off()
